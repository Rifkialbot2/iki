...
*Hello {} !*
────────────────────────
✪ I'm Skytrixs bot designed to help manage your telegram group with a lot features.
✪ Maintained by @Skytrixs ✨
────────────────────────
...
def Skyzu_about_callback(update, context):
    ...
    if query.data == "Skyzu_":
        query.message.edit_text(
            text="๏ I'm *Skytrixs*, a powerful group management bot built to help you manage your group easily."
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(text="sᴜᴘᴘᴏʀᴛ​", url="t.me/baubawangih"),
                        InlineKeyboardButton(
                            text="ᴜᴘᴅᴀᴛᴇs​", url="https://t.me/skytrixss"
                        ),
                    ],
                    [
                        InlineKeyboardButton(text="ɢᴏ ʙᴀᴄᴋ​", callback_data="Skyzu_"),
        ...
        query.message.edit_text(
            text=f"<b>๏ Credis for Skytrixs</b>\n"
            f"\nHere Developers Making The Skytrixsobot",
            parse_mode=ParseMode.HTML,
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(text="Skyzu", url="t.me/baubawangih"),
                    ],
                    [
                        InlineKeyboardButton(text="ɢᴏ ʙᴀᴄᴋ​", callback_data="Skyzu_"),
                    ],
